...
var fromPath = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(bin) {
          ...
          case 4:
            ...
            getPaths = function getPaths() {
              var dev15Paths = ["15.0"].map(function (version) {
                var binFolders = ["bin", "bin/x86", "bin/amd64"];
                var vsVersions = ["2017", "Preview"];
                var roots = [_path2.default.resolve(process.env.ProgramFiles, "Microsoft Visual Studio"), _path2.default.resolve(process.env["ProgramFiles(x86)"], "Microsoft Visual Studio")];
                var allPaths = [];
                ...
                try {
                  for (var _iterator = roots[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    try {
                      for (var _iterator2 = vsVersions[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                        var vsVersion = _step2.value;

                        var folder = _path2.default.join(root, vsVersion);
                        try {
                          var content = _fsExtra2.default.readdirSync(folder);
                          ...
                          try {
                            for (var _iterator3 = content[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                              ...
                              try {
                                for (var _iterator4 = binFolders[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                                  var binFolder = _step4.value;

                                  allPaths.push(_path2.default.join(folder, dir, "msbuild", version, binFolder));
                                }
                              } catch (err) {
...
var validatePythonVersion = function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(python) {
    var info, version;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 1;
            _context5.next = 4;
            return (0, _execa2.default)(python, ["--version"], {
              timeout: 30000
            });
          ...
          case 4:
            info = _context5.sent;
            _context5.prev = 5;
            version = parseFloat(/python (\d+\.\d+)/ig.exec(info.stdout + info.stderr)[1]);
...
var searchPython = function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6() {
    var locations, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, loc, _arr, _i, bin, python;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            _context6.prev = 7;
            _iterator5 = locations[Symbol.iterator]();
          ...
          case 2:
            ...
            runFn = function runFn(bin) {
              return function () {
                ...
                var proc = (0, _execa2.default)(python, [bin].concat(_toConsumableArray(args)), _extends({
                  stdio: "inherit",
