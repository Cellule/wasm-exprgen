      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 1;
            proc = (0, _spawnExtra2.default)(python, ["--version"], {
              timeout: 30000,
              mixStdOutErr: true
            });
            _context5.next = 5;
          ...
          case 5:
            info = _context5.sent;
            _context5.prev = 6;
            version = parseFloat(/python (\d+\.\d+)/ig.exec(info.stdout)[1]);
          ...
          case 2:
            ...
            runFn = function runFn(bin) {
              return function () {
                ...
                var proc = (0, _spawnExtra2.default)(python, [bin].concat(_toConsumableArray(args)), _extends({
                  stdio: "inherit",
...
var _spawnExtra = require("spawn-extra");

var _spawnExtra2 = _interopRequireDefault(_spawnExtra);
