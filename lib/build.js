        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 19:
            ...
            return new Promise(function (resolve, reject) {
              return (0, _klaw2.default)(buildDir).on("data", function (item) {
                if (_path2.default.extname(item.path) === ".vcxproj") {
                  var content = _fsExtra2.default.readFileSync(item.path).toString().split("\n").filter(function (line) {
                    return line.indexOf("nologo") === -1;
                  }).join("\n");
                  _fsExtra2.default.writeFileSync(item.path, content);
                }
