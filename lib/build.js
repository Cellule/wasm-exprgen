...
var buildLLVM = function () {
  var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2() {
    var _ref4, cmake, msbuild, make, buildDir, llvmPath, solution, proc;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 10:
            llvmPath = _path2.default.join(_init.rootDir, "third_party/emscripten-fastcomp");
...
var prepareEmscriptenConfig = function () {
  var _ref5 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
    var _ref6, python, cleanPath, file, emscriptenFile;
...
(0, _git.checkSubmodules)().then(function () {
  return Promise.all([buildCSmith(), buildLLVM(), prepareEmscriptenConfig()]);
}).catch(function (err) {
