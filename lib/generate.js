...
exports.default = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
    ...
    var _ref3, csmith, wasm, runEmcc, runEmpp, sourceFile, csmithArgs, transpiler, csmithProc, jsFile, wasmFile, specProc, wasmBuffer, string, i, buf, oldFile, fd;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 27:
            ...
            _context.next = 30;
            return transpiler([sourceFile, "-I" + _path2.default.join(_init.toolsDirectory, "csmith/inc"), "-O3", "-s", "WASM=1", "-s", "BINARYEN_METHOD='native-wasm" + (interpreted ? ",interpret-binary" : "") + "'", "-o", jsFile], _extends({ cwd: outdir }, execOptions));
