...
var compile = function () {
  var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
    ...
    var shouldInlineWasm, jsFile, wasmFile, wastFile, isValid, wasmSpecOutput, specProc, match, specErrorMessage, newJsFile, oldFile, fd, wasmBuffer, string, i, buf, nodeRegenOption;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            _context3.next = 6;
            return transpiler([sourceFile, "-I" + _path2.default.join(_init.toolsDirectory, "csmith/inc"), "-s", "WASM=1", "-s", "BINARYEN_METHOD='native-wasm" + (interpreted ? ",interpret-binary" : "") + "'", "-s", "BINARYEN_ASYNC_COMPILATION=0", "-g"].concat(_toConsumableArray(emOptions), ["-o", jsFile]), _extends({ cwd: outdir }, execOptions));
          ...
          case 6:
            ...
            isValid = false;
            specProc = (0, _child_process.spawn)(specInterpreter, [wasmFile, "-d"], {
              cwd: outdir
            });
            _context3.prev = 13;
            _context3.next = 16;
...
exports.default = function () {
  var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
    ...
    var _ref$sourceType = _ref.sourceType,
        ...
        args = _objectWithoutProperties(_ref, ["sourceType", "fileName", "outdir", "execOptions"]);
