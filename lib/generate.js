      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 28:
            ...
            _context.next = 32;
            return transpiler([sourceFile, "-I" + _path2.default.join(_init.toolsDirectory, "csmith/inc"), "-s", "WASM=1", "-s", "BINARYEN_METHOD='native-wasm" + (interpreted ? ",interpret-binary" : "") + "'", "-s", "BINARYEN_ASYNC_COMPILATION=0", "-g"].concat(_toConsumableArray(randomOptions), ["-o", jsFile]), _extends({ cwd: outdir }, execOptions));
