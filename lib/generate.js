...
var compile = function () {
  var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3() {
    ...
    var shouldInlineWasm, jsFile, clangFlags, isCpp11, wasmFile, wastFile, isValid, wasmSpecOutput, specProc, match, specErrorMessage, newJsFile, oldFile, fd, wasmBuffer, string, i, buf, nodeRegenOption;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 9:
            ...
            isValid = false;
            specProc = (0, _spawnExtra2.default)(specInterpreter, [wasmFile, "-d"], {
              cwd: outdir,
              timeout: 5 * 60 * 1000
            });
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 24:
            csmithProc = (0, _spawnExtra2.default)(csmith, ["-o", sourceFile].concat(csmithArgs), _extends({
              stdio: "inherit",
              cwd: outdir,
              timeout: 5 * 60 * 1000,
              collectStdOut: false
