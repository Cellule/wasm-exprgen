...
var doGenerate = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(genFn, maxAttempts, args) {
    var nAttempts, lastError, _ref2, wasm, src, js, valid;
...
_yargs3.default.usage().help().alias("h", "help").wrap(Math.min(_yargs3.default.terminalWidth() - 1, 120)).command({
  ...
  handler: function handler(argv) {
    ...
    doGenerate(_generate2.default, argv.attempts, args).catch(function () {
  ...
  handler: function handler(argv) {
    ...
    doGenerate(_generate.compileFromSource, 1, args).catch(function () {
      return process.exit(1);
    });
  }
}).demand(1).argv;